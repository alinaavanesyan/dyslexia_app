...
class _RegisterPageState extends State<RegisterPage> {
  ...
  Future<void> signUp() async {
    ...
    print(passwordTextRepeatInputController.text);
    print(passwordTextInputController.text);
    print(emailTextInputController.text);
    print(nameTextInputController.text);
    ...
    // final isValid = formKey.currentState!.validate();
    // if (!isValid) {
    //   formKey.currentState!.fields.forEach((field) {
    //     if (!field.validate()) {
    //       // Проверка не пройдена для поля field.key
    //       print('Проверка не пройдена для поля ${field.key}');
    //     }
    //   });
    //   return;
    // }
