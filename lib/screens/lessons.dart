                        ...
                        builder: (context, snapshot) {
                          if (snapshot.connectionState == ConnectionState.waiting) {
                            ...
                            return Container(
                                ...
                                snapshot.data == 1
                                ? Colors.green // Зеленый цвет, если значение равно 1
                                    : snapshot.data == 0
                                ? Colors.grey // Серый цвет, если значение равно 0
                                : Colors.orange // Оранжевый цвет для остальных значений
                            )));
                        }
                      },
                    ),
...
class _LessonDetailScreenState extends State<LessonDetailScreen> {
    ...
    res.then((done_tasks) {
      ...
      if (all_indexes.length != 0) {
        setState(() {
          ...
          change = true;
          // widget.hearTask.onGameUpdate = _handleGameUpdate;
          print(
  ...
  Widget hearTask(index) {
    print('виджет строится для $index');
